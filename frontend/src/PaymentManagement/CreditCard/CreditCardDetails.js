  ...
  render() {
    ...
    return (
      ...
      <div className="container" >
       <p><h2>✤✤View Added Cards✤✤</h2></p>
         <table class="table table-hover">
           <thead class="table table-bordered table-dark">
             <tr>
               <th scope="col"><h3>No</h3></th>
               <th scope="col"><h3>Card Type</h3></th>
               <th scope="col"><h3>Card Number</h3></th>
               <th scope="col"><h3>&nbsp;&nbsp;Holder Name</h3></th>
               <th scope="col"><h3>Expire Date</h3></th>
           ...
           <tbody>
             {this.state.Payment.map((Payment,index) =>(
               <tr>
                  ...
                  <td><h5>&nbsp;&nbsp;Visa</h5>&nbsp;</td>
                  <td><h5>xxxx-xxxx-xxxx-5698</h5></td>
                  <td><h5>&nbsp;&nbsp;&nbsp;&nbsp;{Payment.name}</h5></td>
                  <td><h5>&nbsp;&nbsp;{Payment.expiry}</h5></td>
                  <td>
