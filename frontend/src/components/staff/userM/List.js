...
export default class UserList extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:8085/api/auth/displayUsers')
      .then(res => {
        this.setState({
          students: res.data
        });
    ...
    <div>
        <nav className="navbar navbar-expand-lg navbar-light bg-light sticky-top">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li className="nav-item">
                    <Link className="nav-link active" to = "/display-userM"><i class="fa fa-users" aria-hidden="true"></i>Display Users</Link>
                </li>
