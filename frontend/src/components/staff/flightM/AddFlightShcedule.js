...
const AddFlightShcedule = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8085/flights/add', {id,flight,date,destination,sheduleddeparturetime,assignplanetype,capacity,seatsreserved,availableclasses})
             .then(res => {
                console.log(res);
                setLoading(false);
    ...
    return (
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 nav nav-tabs">
              ...
              <li className="nav-item">
                <Link className="nav-link active" to = "/add-flightM"><i class="fa fa-plus-square" aria-hidden="true"></i> Add shcedule</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link " to = "/display-flightM"><i class="fa fa-plane" aria-hidden="true"></i> Display Shcedules</Link>
              </li>

              {/* <li className="nav-item">
                <Link className="nav-link " to = "/assigndeliveries-flightM"><i class="fa fa-truck" aria-hidden="true"></i>Help</Link>
              </li> */}
              {/* <li className="nav-item">
      ...
      <h1>📝Add shedule✍🏻</h1>
            ...
            <div className="cmb-3">
                ...
                /><br></br>
                <label for="flight" style={{float:"left",color:"black"}} className="form-label">Flight</label>
                <input 
                    type="text"
                    ...
                    name="flight"
                    value={flight}
                    onChange={(e)=> setFlight(e.target.value)} required
                /><br></br>
                <label for="date" style={{float:"left",color:"black"}} className="form-label">Date</label>
                <input 
                    type="date"
                ...
                /><br></br>
                <label for="destination" style={{float:"left",color:"black"}} className="form-label">Destination</label>
                <input 
                    type="text"
                ...
                /><br></br>
                <label for="sheduleddeparturetime" style={{float:"left",color:"black"}} className="form-label">sheduled departure time</label>
                <input 
                    type="text"
                    ...
                    onChange={(e)=> setSheduleddeparturetime(e.target.value)} required
                /><br></br>
                <label for="assignplanetype" style={{float:"left",color:"black"}} className="form-label">Assign plane type</label>
                <input 
                    type="text"
                ...
                /><br></br>
                 <label for="capacity" style={{float:"left",color:"black"}} className="form-label">Capacity</label>
                 <input 
                type="text"
            ...
            /><br></br>
               ...
               <label for="seatsreserved" style={{float:"left",color:"black"}} className="form-label">Seats Reserved</label>
                 <input 
                type="text"
                ...
                name="seatsreserved"
                value={seatsreserved}
                onChange={(e)=> setSeatsreserved(e.target.value)} required


                
            /><br></br>
            
            <label for="availableclasses" style={{float:"left",color:"black"}} className="form-label">Available Classes</label>
                 <input 
                type="text"
