...
const FlightManagerLogin = ()=>{
    ...
    const loginHandler = async (e)=>{
        ...
        try {
            ...
            const {data} = await axios.post("http://localhost:8085/api/auth/staff-login-flightM" , {email , password} , config);
...
export default FlightManagerLogin;